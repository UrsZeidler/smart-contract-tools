...
class ExpressionTest extends AbsExpressionTest {
	...
	// This fails for the built-in xtext terminals, but passes with
	// the custom terminal converter for BigIntegers
	@Test
	...
	@Test
	def void givenTwoToNintyFive_whenParsed_thenParsedValueIsCorrect() {
		'''39614081257132168796771975168'''.assertRepr("39614081257132168796771975168")
	}

	// See: http://www.tsm-resources.com/alists/pow2.html
	@Test
	def void givenTwoTo222_whenParsed_thenParsedValueIsCorrect() {
		'''6739986666787659948666753771754907668409286105635143120275902562304'''.assertRepr(
			"6739986666787659948666753771754907668409286105635143120275902562304")
	}

	// See: http://www.tsm-resources.com/alists/pow2.html
	@Test
	def void givenTwoTo256_whenParsed_thenParsedValueIsCorrect() {
		'''115792089237316195423570985008687907853269984665640564039457584007913129639936'''.assertRepr(
